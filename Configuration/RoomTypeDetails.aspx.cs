...
public partial class Configuration_RoomTypeDetails : System.Web.UI.Page
{
    ...
    protected void BindRoomType_OnlineDetails(int roomType)
    {
        ...
        /*this.drpNumberOfRooms.SelectedValue = dt.Rows[0]["Number_Of_Rooms"].ToString();
        this.drpNumberOfBedRooms.SelectedValue = dt.Rows[0]["Number_Of_BedRooms"].ToString();
        this.drpNumberOfBathRooms.SelectedValue = dt.Rows[0]["Number_Of_Bathrooms"].ToString();
        this.drpNumberOfLivingRooms.SelectedValue = dt.Rows[0]["Number_Of_LivingRooms"].ToString();
        this.drpNumberOfChildren.SelectedValue = dt.Rows[0]["Number_Of_Children"].ToString();
        this.drpNumberOfAdults.SelectedValue = dt.Rows[0]["Number_Of_Adults"].ToString();
        this.drpNumberOfKitchens.SelectedValue = dt.Rows[0]["Number_Of_Kitchen"].ToString*/
