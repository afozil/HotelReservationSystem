...
<%
    ...
    '   Order.auth      = auth
       ...
       ' payment gateway
    */
    //Response.Write("REDIRECT=https://www.failakaonline.com/app/paymentconfirmed?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
    
    if ( result=="CAPTURED"){
        // Read by PG and redirects the user to this URL 	
        Response.Write("REDIRECT=https://www.failakaonline.com/app/paymentconfirmed?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
        //Response.Write("REDIRECT=http://localhost:65411/paymentconfirmed?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);  
    }else if(result=="CANCELED"){
        //Response.Write("http://www.google.com?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
        Response.Write("REDIRECT=https://www.failakaonline.com/app/error?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);    
    } else{
        Response.Write("REDIRECT=https://www.failakaonline.com/app/error?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
        //Response.Write("REDIRECT=http://localhost:65411/Error.aspx?PaymentID=" + paymentID + "&Result=" + result + "&PostDate=" + postdate + "&TranID=" + tranid + "&Auth=" + auth + "&Ref=" + refr + "&TrackID=" + trackid + "&UDF1=" + udf1 + "&UDF2=" + udf2  + "&UDF3=" + udf3  + "&UDF4=" + udf4 + "&UDF5=" + udf5);
    }
