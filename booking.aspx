<%@ Page Title="" Language="C#" MasterPageFile="~/OnlineInside.master" AutoEventWireup="true" CodeFile="booking.aspx.cs" Inherits="booking" EnableEventValidation="False" %>
<asp:Content ID="BookingContent" ContentPlaceHolderID="MainContent" runat="Server">
                                                                    ...
                                                                    <asp:Panel ID="pnlResults" runat="server" Visible="false">
                                                                        <div class="panel-body">
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="row">
                                                                                        <div class="col-md-12">
                                                                                            <table width="915px" align="center">
                                                                                                <tbody>
                                                                                                    <asp:DataList ID="roomTypesList" runat="server" OnItemDataBound="roomTypesList_ItemDataBound"
                                                                                                        RepeatColumns="1" RepeatDirection="Horizontal" DataKeyField="RoomType_ID" RepeatLayout="Flow" GridLines="None"
                                                                                                                ...
                                                                                                                <tr style="border: 1px solid Gray;">
                                                                                                                    <td>
                                                                                                                        <table style="width: 100%" cellpadding="5px" cellspacing="5px">
                                                                                                                            <tr>
                                                                                                                                <td style="border: medium none; width: 200px">
                                                                                                                                    <div class="col-md-12">
                                                                                                                                ...
                                                                                                                                <td style="border: medium none; width: 250px; background-color:#f8f2f2">
                                                                                                                                    <div class="col-md-12">
                                                                                                                                        <div class="row">
                                                                                                                                            <div class="col-md-8">
                                                                        ...
                                                                        <div class="panel-footer">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-2">
                                                                                    <asp:LinkButton ID="lnkPrevious" runat="server" class="btn btn-default btn-sm" OnClick="lnkPrevious_Click"><span class="glyphicon glyphicon-backward" aria-hidden="true"></span>
                                                                                    </asp:LinkButton>
                                                                                    <asp:HiddenField ID="hidPageCount" runat="server"></asp:HiddenField>
                                                                                    <asp:LinkButton ID="lnkNext" runat="server" class="btn btn-default btn-sm" OnClick="lnkNext_Click"><span class="glyphicon glyphicon-forward" aria-hidden="true"></span></asp:LinkButton>
                                                                                </div>
                                                                                <div class="col-md-5">&nbsp;</div>
                                                                            </div>
                                                                        </div>
    ...
    <asp:UpdateProgress ID="myReseversationUpdateProgress" runat="server">
        <ProgressTemplate>
