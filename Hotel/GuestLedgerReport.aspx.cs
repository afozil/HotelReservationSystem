...
public partial class Hotel_GuestLedgerReport : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
       // EmpID = "1";
      //  DataTable table = reserv.SelectGuestLedgerReport(EmpID, DateTime.Now.ToString("MM/dd/yyyy"));
      
        DataTable table = reserv.SelectGuestLedgerReport(EmpID,"11/02/2015");
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('RptGuestLedgerView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
