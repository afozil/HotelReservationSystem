<%@ Page Title="Amenities" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddAmenities.aspx.cs" Inherits="Hotel_AddAmenities" %>
            ...
            <div class="failaka">
                ...
                <div class="row">
                    <div class="col-md-3">
                     ...
                     <div class="col-md-3">
                        <label for="drpSalutation">Amenities</label>
                        <asp:DropDownList ID="drpAmenities" runat="server" class="form-control input-md" AutoPostBack="True" OnSelectedIndexChanged="drpAmenities_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row">
