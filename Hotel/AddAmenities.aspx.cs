...
public partial class Hotel_AddAmenities : System.Web.UI.Page
{
    ...
    private void BindAmenities()
    {
        ...
        DataTable table = amenities.SelectAll();
        drpAmenities.DataSource = table;
        drpAmenities.DataTextField = "AmenitiesName";
        drpAmenities.DataValueField = "AmenitiesID";
        drpAmenities.DataBind();
        drpAmenities.Items.Insert(0, new ListItem("Select an Amenity....", "-1"));
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            lblStatus.Text = "Please choose amenity"; return;
        }
        ...
        rp.AvailedService_Type = PAYMENT_AVAILED_SERVICETYPES.AMENITIES;
        rp.Rate_ID = SqlInt32.Parse(drpAmenities.SelectedValue);
        ...
        if (rp.Insert())
        {
            ...
            row["ServiceName"] = drpAmenities.SelectedItem.Text;
