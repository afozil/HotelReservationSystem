...
public partial class Hotel_SalesCollectionReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Context.User.IsInRole("administrator") || Context.User.IsInRole("sales"))
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
       ...
       // EmpID = "1";
        DataTable table = reserv.SelectSalesCollectionReport(EmpID, fromDate.ToString(), toDate.ToString(), username);
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('CollectionReportView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
