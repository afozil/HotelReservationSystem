...
public partial class Hotel_ArrivalReport : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
        //EmpID = "1";
        DataTable table = reserv.SelectARRIVALReport(EmpID, fromDate.ToString());
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('http://server.heritagevillagefailaka.com/Failaka/hotel/RptArrivalView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
                          "menubar=no, scrollbars=yes, resizable=yes')" +
                          "</script>";

        //string popupScript = "<script language='javascript'>" +
        //               "window.open('RptArrivalView.aspx','ThisPopUp1', " +
        //               "'left = 300, top=150,  " +
        //               "menubar=no, scrollbars=yes, resizable=yes')" +
        //               "</script>";
