...
public partial class Hotel_FOCollectionReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Context.User.IsInRole("administrator") || Context.User.IsInRole("frontoffice"))
        {
    ...
    {
        DataTable table = new Employees().SelectByRoleName("frontoffice");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
       ...
       // EmpID = "1";
        DataTable table = reserv.SelectFrontOfficeCollectionReport(EmpID, fromDate.ToString(), toDate.ToString());
        Session["collectionRpt"] = table;
        string popupScript = "<script language='javascript'>" +
                          "window.open('FoCollectionReportView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
