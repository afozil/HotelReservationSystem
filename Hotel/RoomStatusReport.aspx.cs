...
public partial class Hotel_RoomStatusReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Context.User.IsInRole("administrator") || Context.User.IsInRole("housekeeping"))
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
        //EmpID = "1";
        DataTable table = reserv.SelectRoomStatusReport(EmpID);
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('RptRoomStatusView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
