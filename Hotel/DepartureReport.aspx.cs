...
public partial class Hotel_DepartureReport : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        //}
        EmpID = "1";
        DataTable table = reserv.SelectDepartureReport(EmpID, fromDate.ToString());
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('DepartureView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
