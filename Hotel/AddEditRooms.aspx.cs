...
public partial class Hotel_AddEditRooms : System.Web.UI.Page
{
    ...
    private void BindRoom(int roomId)
    {
        ...
        foreach (ListItem li in drpIsCookingFacilityVailable.Items)
        {
            if (li.Value.Equals(room.IsCookingFaclity_Available.ToString())) { 
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in drpIsOutOfOrder.Items)
        {
            if (li.Value.Equals(room.Is_Out_Of_Order.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in drpIsReferigeratorVailable.Items)
        {
            if (li.Value.Equals(room.IsRefregerator_Available.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpMaxGents.Items)
        {
            if (li.Value.Equals(room.MaximumGents_Allowed.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpMaxKids.Items)
        {
            if (li.Value.Equals(room.MaximumKids_Allowed.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpMaxOccupancy.Items)
        {
            if (li.Value.Equals(room.MaximumOccupancy_Allowed.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in drpNumBathrooms.Items)
        {
            if (li.Value.Equals(room.Number_Of_Bathrooms.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in drpNumBeds.Items)
        {
            if (li.Value.Equals(room.Number_Of_Beds.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpNumKitchens.Items)
        {
            if (li.Value.Equals(room.Number_Of_Kitchen.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpNumLivingRooms.Items)
        {
            if (li.Value.Equals(room.Number_Of_LivingRooms.ToString()))
            {
                li.Selected = true;
                break;
            }
        ...
        foreach (ListItem li in drpNumTV.Items)
        {
            if (li.Value.Equals(room.Number_Of_TV.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in drpRoomStatus.Items)
        {
            if (li.Value.Equals(room.RoomStatus_ID.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in cboRoomType.Items)
        {
            if (li.Value.Equals(room.RoomType_ID.ToString()))
            {
                li.Selected = true;
                break;
            }
        }
        foreach (ListItem li in cboProperties.Items)
        {
            if (li.Value.Equals(room.Property_ID.ToString()))
            {
                li.Selected = true;
                break;
            }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            room.RoomStatus_ID = Int32.Parse(drpRoomStatus.SelectedValue);
            ...
            room.LastModifiedDate = SqlDateTime.Parse(DateTime.Now.ToString());
