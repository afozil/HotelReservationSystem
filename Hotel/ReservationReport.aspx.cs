...
public partial class Hotel_ReservationReport : System.Web.UI.Page
{
    ...
    { lblMsg.Text = string.Empty;
        ...
        string EmpID = "0";
         ...
         // EmpID = "1";
        DataTable table = reserv.SelectSalesReservationReport(EmpID, fromDate.ToString(), toDate.ToString(),username);
        ...
        string popupScript = "<script language='javascript'>" +
                          "window.open('ReservationReportView.aspx','ThisPopUp1', " +
                          "'left = 300, top=150,  " +
